        ...
        return(
            <section className="music-player">
                ...
                <section className="emotion__wrapper">
                    <button><img src={happy} className="emotion__wrapper--face" alt="happy" /></button>
                    <button><img src={energetic} className="emotion__wrapper--face" alt="energetic" /></button>
                    <button><img src={anxious} className="emotion__wrapper--face" alt="anxious" /></button>
                    <button><img src={angry} className="emotion__wrapper--face" alt="angry" /></button>
                    <button><img src={neutral} className="emotion__wrapper--face" alt="neutral" /></button>
                    <button><img src={chill} className="emotion__wrapper--face" alt="chill" /></button>
                    <button><img src={sad} className="emotion__wrapper--face" alt="sad" /></button>
                    <button><img src={social} className="emotion__wrapper--face" alt="social" /></button>
